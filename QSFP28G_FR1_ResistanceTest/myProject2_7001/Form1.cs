...
namespace myProject2_7001
{
    ...
    {
        public Ke2400 ke2400Ctrl1 = new Ke2400();
        public static Ke7001Ctrl ke7001Ctrl1 = new Ke7001Ctrl();
        ...
        {
             //doResistanceTestByCurrent(2, 2 , 5);
            resistanceTest(2,2);
        }
        ...
        private void ReadDefaultSettings()
        {
            ...
            lotNumber = myProject2_7001.Properties.Settings.Default.lotNumber;
            serialNumber = myProject2_7001.Properties.Settings.Default.serialNumber;
            operatorName = myProject2_7001.Properties.Settings.Default.operatorName;
            ...
            configFile = myProject2_7001.Properties.Settings.Default.configFile;
            dataOutputPath = myProject2_7001.Properties.Settings.Default.dataOutputPath;
            //testSpec = myProject2_7001.Properties.Settings.Default.testSpec;

            //Label_resultFolder.Text = dataOutputPath;
            //Label_testSpec.Text = testSpec;

            ke2400_gpib = (byte)myProject2_7001.Properties.Settings.Default.ke2400_gpib;
            ke7001_gpib = (byte)myProject2_7001.Properties.Settings.Default.ke7001_gpib;


        //    TestPhase = (TestPhase)Enum.Parse(
        //      typeof(TestPhase), myProject2_7001.Properties.Settings.Default.testPhase);
        //}
            TestPhase value;
            if (!Enum.TryParse(myProject2_7001.Properties.Settings.Default.testPhase.ToString(), out value))
            {
                myProject2_7001.Properties.Settings.Default.testPhase = "None";
                myProject2_7001.Properties.Settings.Default.Save();
            }
        ...
        {
            myProject2_7001.Properties.Settings.Default.lotNumber = lotNumber;
            myProject2_7001.Properties.Settings.Default.serialNumber = serialNumber;
            myProject2_7001.Properties.Settings.Default.operatorName = operatorName;

            myProject2_7001.Properties.Settings.Default.configFile = configFile;
            myProject2_7001.Properties.Settings.Default.dataOutputPath = dataOutputPath;
            //myProject2_7001.Properties.Settings.Default.testSpec = testSpec;

            myProject2_7001.Properties.Settings.Default.ke2400_gpib = ke2400_gpib;
            myProject2_7001.Properties.Settings.Default.ke7001_gpib = ke7001_gpib;


            myProject2_7001.Properties.Settings.Default.testPhase = TestPhase.ToString();
        ...
        public bool TestInitialization()
        {
            ...
            if (ke2400Ctrl1 != null)
            {
                ...
                ke2400Ctrl1.SetCompliance(myProject2_7001.Properties.Settings.Default.compliance);
